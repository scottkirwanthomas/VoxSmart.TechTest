...
{
    [TestFixture]
    public class GivenAnEnergyCommoditiesStrategy
    {
        ...
        public void SetUp()
        {
            ...
            _sut = new EnergyCommoditiesStrategy(_mockOptions.Object);
        }
        ...
        {
            var marketItems = new List<MarketItem> { new MarketItem { Title="Oil at it again", Description = "of all the energy in the world Crude oil is the dirtiest" } };
            var expectedResults = new List<string> { "Crude Oil" };
